...
class SettingsPage extends StatelessWidget {
          ...
          children: [
            ...
            _buildSettingsBox(
              items: [
                ...
                _buildSettingsItem(icon: Icons.delete_forever, title: "Delete My Account", isLast: false),
                _buildSettingsItem(icon: Icons.credit_card, title: "Billing Info", isLast: true),
              ],
            ),
            ...
            _buildSettingsBox(
              items: [
                ...
                _buildSettingsItem(icon: Icons.lock, title: "Privacy Policy", isLast: false),
            ...
            // 🔹 4) THIRD LIST BOX (Tell a Friend)
            _buildSettingsBox(
              items: [
                _buildSettingsItem(icon: Icons.share, title: "Tell a Friend", isLast: true),
              ],
            ),
  ...
  // 🔧 Utility: Create Settings Box
  Widget _buildSettingsBox({required List<Widget> items}) {
    return Container(
  ...
  Widget _buildSettingsItem({
    ...
    return Column(
      children: [
        ...
        // 🔥 Divider from icon to arrow (not full width)
        if (!isLast)
          Padding(
