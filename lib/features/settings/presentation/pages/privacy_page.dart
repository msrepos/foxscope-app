...
class PrivacyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const AppHeader(title: "Privacy Center"),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              "This Privacy Center describes how this application collects, uses, and protects your information. By using this app, you agree to the collection and use of information in accordance with this policy.",
